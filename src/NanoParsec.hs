...
{-
  ...
  to indicate where parsing succeeded, stopped, and what if any of the input String
  is remaining for a subsequent parser.

  Parser combinators then are a collection of higher-order functions whose input
